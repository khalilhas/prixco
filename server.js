    ...
    if(!error)
    {
        ...
        fs.readFile('index.html',(err, data) => {
            ...
            for(var i = 0; i <  json.item.length;i++)
            {
              ...
              $('tbody').append("<tr><th scope='row'>" + count + "</th><td>"+ item.title +"</td><td>" + item.price +"</td><td><a href='"+ item.urldesc +"'>"+ item.location +"</a></td><td><a href=''><img class='deleteitem' src='./img/close.png'/></a></td></tr>");
            }
